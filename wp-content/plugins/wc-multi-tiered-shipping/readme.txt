...
3. Click on "Multi-Tiered Shipping" in the "Shipping Methods" table to enable this 
shipping method and update its settings.

== Screenshots ==

1. WooCommerce Shipping options, see last option, "Multi-Tiered" shipping.
1. Multi-Tier shipping options.
