		...
		$output .= (!empty($animation_box) ? '<div class="ts-hover ' . $animation_box . '">' : '');
			if ($style == "icon_left") {
				$output .= '<div class="ts-css-shadow ' . $animation_shadow . '" style="' . $box_background_style . '">';
					$output .= '<div class="box-detail-wrapper" style="' . $box_frame_style . '">';
				...
				$output .= '<div class="ts-css-shadow ' . $animation_shadow . '" style="' . $box_background_style . '">';
					$output .= '<div class="top-side ' . $animation_css . '" style="' . $box_frame_style . '">';
						if ($icon_replace == 'false') {
							if (!empty($icon)) {
				...
				$output .= '<div class="ts-css-shadow ' . $animation_shadow . '" style="background-color: ' . $box_background_color .'; ' . $shadow_frame_adjust . '">';
					$output .= '<div class="ts-icon-box-boxed  ' . $icon_location . $animation_css . '" style="' . $box_frame_style . ' ' . $box_frame_adjust . ' ' . $box_background_style .'">';
						if ($icon_replace == 'false') {
							if (!empty($icon)) {
